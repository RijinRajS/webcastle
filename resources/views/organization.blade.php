                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb pull-right">
                                    <li><a href="#">{{$detail->username}}</a></li>
                ...
                @endif
                                ...
                                <table class="table table-striped add-edit-table dt-responsive nowrap" id="datatable-editable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="actions">
                                            <a href="{{route('view',$organisation)}}" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Show"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
