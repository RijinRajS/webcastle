    ...
    <body style="background-color:#007bff">
        ...
        <div class="wrapper-page">
            <div class="card card-pages">
                ...
                <div class="card-body">
                <form class="form-horizontal m-t-20" action="{{route('register-user')}}" method="POST">
                @csrf
                <h3 class="text-center m-t-10 text-black"><strong>Registration</strong> </h3><br>
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <input class="form-control input-lg" type="password" name="confirmpassword"  placeholder="Confirm Password" value="{{old('confirmpassword')}}">
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <input class="form-control input-lg" type="date" name="dob"  placeholder="date of birth" value="{{old('dob')}}">
