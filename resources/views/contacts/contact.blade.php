            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Create Contact</h4>
                ...
                <table style="width:100%">
                                           <td> <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Enter firstname" value="{{old('firstname')}}" style="width:90%">
                                                <span style="color:red">@error('firstname'){{$message}} @enderror</span>
                                            </div></td>
                                           <td> <div class="form-group">
                                                <label for="exampleInputPassword1">Last name</label>
                                                <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Lastname" value="{{old('lastname')}}" style="width:90%">
